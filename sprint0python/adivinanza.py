def showRiddle():    
    ...
    if(score == 0):
        ...
        print("Tu puntuación es de ",score," puntos! No puedes ser tan mal@ ni queriendo")

    elif(score == 15):

        print("Tu puntuación es de ",score," puntos! Sé que puedes hacerlo mejor")
        
    elif(score == 30):

        print("Tu puntuación es de ",score," puntos! Perfecto!")     
